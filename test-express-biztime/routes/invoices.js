...
router.put("/:id", async function (req, res, next) {
    try {
        ...
        const result = await db.query(`UPDATE invoices SET amt=1$, paid=2$, paid=3$ WHERE id=4$ RETURNING id, comp_code, amt, paid, add_date, paid_date`, [amt, paid, paidDate, id])
